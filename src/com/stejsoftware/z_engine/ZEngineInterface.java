...
import com.stejsoftware.z_engine.shared.msg.Erase;
import com.stejsoftware.z_engine.shared.msg.Message;
import com.stejsoftware.z_engine.shared.msg.Quit;
import com.stejsoftware.z_engine.shared.msg.Status;
import com.stejsoftware.z_engine.shared.msg.Text;
import com.stejsoftware.z_engine.zmachine.Dimension;
import com.stejsoftware.z_engine.zmachine.Point;
import com.stejsoftware.z_engine.zmachine.ZUserInterface;

/**
 * @author jon
 * 
 */
public class ZEngineInterface implements ZUserInterface
{
    private static Logger  log             = LoggerFactory.getLogger(ZEngineInterface.class);
    ...
    {
        log.info("setTerminatingCharacters: {}");
        // TODO Auto-generated method stub
    }
