...
public class StringTokenizer implements java.util.Enumeration<String>, java.util.Iterator<String>
{
     ...
     * more in depth analysis. (for example search the delimiter string.) This
     * will reduce the running time of the algorithm not to depend on the length
    ...
    /**
     * Whether empty tokens should be returned. for example, if "" should be
     * returned when text starts with a delimiter, has two delimiters next to
     * each other, or ends with a delimiter.
     * 
     * @since ostermillerutils 1.00.00
     */
     ...
     * string will be treated as if it is being parsed from position zero, for
     * example, null strings are possible at the very beginning.
     * 
     * @since ostermillerutils 1.00.00
     */
     ...
     *            the non-token delimiters, i.e. the delimiters that only
    ...
    /**
     * Constructs a string tokenizer for the specified string. Both token and
     * non-token delimiters are specified and whether or not empty tokens are
     ...
     *            or non-token delimiters: <code>false</code> -- the second
     *            parameter specifies non-token delimiters, the set of token
     *            delimiters is empty; <code>true</code> -- the second parameter
     *            specifies token delimiters, the set of non-token delimiters is
     *            empty.
     * @throws NullPointerException
     *             if text is null.
     * 
     ...
     * uses " \t\n\r\f" as a delimiter set of non-token delimiters, and an empty
     * token delimiter set.
     * <p>
     ...
     * tokenizers do not have to be created for each string you want to
     * tokenizer.
     * <p>
     ...
     * <p>
     * This method skips non-token delimiters but does not skip token
     * delimiters.
     * <p>
     ...
     * 
     * @param delims
     *            the new set of non-token delimiters (the set of token
     ...
     *            non-token delimiters: false -- the first parameter specifies
     *            non-token delimiters, the set of token delimiters is empty;
     *            true -- the first parameter specifies token delimiters, the
     *            set of non-token delimiters is empty.
     * 
     * @since ostermillerutils 1.00.00
     */
     ...
     * 
     * @param nontokenDelims
     *            the new set of non-token delimiters.
     * @param tokenDelims
     ...
     * Calculates the number of times that this tokenizer's
     * <code>nextToken</code> method can be called before it generates an
     * exception using the given set of (non-token) delimiters. The delimiters
     ...
     * 
     * @param delims
     *            the new set of token or non-token delimiters.
     * @param delimsAreTokens
     *            flag indicating whether the first parameter specifies token or
     *            non-token delimiters: <code>false</code> -- the first
     *            parameter specifies non-token delimiters, the set of token
     *            delimiters is empty; <code>true</code> -- the first parameter
     *            specifies token delimiters, the set of non-token delimiters is
     *            empty.
     * @return the next token, after switching to the new delimiter set.
     * @throws NoSuchElementException
